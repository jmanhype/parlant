...
def given_a_tool(
    ...
    tools: dict[str, dict[str, Any]] = {
        ...
        "is_product_category_in_stock": {
            "name": "is_product_category_in_stock",
            "description": "Verifies if product category is in stock",
            "module_path": "tests.tool_utilities",
            "parameters": {
                "category": {
                    "type": "string",
        ...
        "get_products_by_tags": {
            ...
            "description": "Returns a list of products by tags",
            "module_path": "tests.tool_utilities",
            "parameters": {
                "category": {
                    "type": "string",
