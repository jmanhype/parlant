Feature: Moderation
    ...
    Scenario: The agent responds to a censored harassment message
        ...
        And a guideline to recommend Coke when the user's last message is censored
        And a guideline to explain the exact reason for censuring the user's message when the user's last message is censored
