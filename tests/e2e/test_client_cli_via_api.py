...
from emcie.server.core.services.tools.plugins import tool, ToolEntry, PluginServer
...
async def test_that_view_a_guideline_with_connections_displays_indirect_and_direct_connections(
    ...
    with run_server(context):
        ...
        assert predicate1 in output
        assert action1 in output

        assert "Direct Entailments:" in output
        assert first_connection["id"] in output
        assert predicate2 in output
        assert action2 in output

        assert "Indirect Entailments:" in output
        assert second_connection["id"] in output
        assert predicate3 in output
        assert action3 in output
