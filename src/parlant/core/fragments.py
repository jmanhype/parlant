...
class Fragment:
    ...
    value: str
    fragment_fields: Sequence[FragmentField]
    tags: Sequence[TagId]
...
class _FragmentDocument(TypedDict, total=False):
    ...
    creation_utc: str
    value: str
    fragment_fields: Sequence[_FragmentFieldDocument]
    ...
    def _serialize_fragment(self, fragment: Fragment) -> _FragmentDocument:
        return _FragmentDocument(
            ...
            fragment_fields=[
                ...
                for s in fragment.fragment_fields
            ],
        )
    ...
    async def _deserialize_fragment(self, fragment_document: _FragmentDocument) -> Fragment:
        ...
        return Fragment(
            ...
            fragment_fields=[
                ...
                for d in fragment_document["fragment_fields"]
            ],
            tags=tags,
        )
        ...
        async with self._lock.writer_lock:
            ...
            result = await self._fragments_collection.update_one(
                ...
                params={
                    ...
                    "fragment_fields": [
                        {"name": s.name, "description": s.description, "examples": s.examples}
                        for s in params["fragment_fields"]
                    ],
                },
            )
