...
export default function GradiantButton({className, buttonClassName, children, onClick}: GradiantButtonProps): ReactElement {
  return (
    <span tabIndex={0} onKeyDown={spaceClick} onClick={onClick} data-testid="gradiant-button" role='button' className={styles.colorsButton + ' relative block rounded-md border-2 border-transparent hover:animate-background-shift ' + (className || '')}>
