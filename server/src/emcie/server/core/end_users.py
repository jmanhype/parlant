...
class EndUserDocumentStore(EndUserStore):
    def __init__(
        ...
        self._collection = end_user_collection
    ...
    async def create_end_user(
        ...
        await self._collection.add_document("end_users", end_user.id, end_user)
        return end_user
    ...
    async def read_end_user(
        ...
        return await self._collection.read_document("end_users", end_user_id)
