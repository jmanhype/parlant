...
def test_that_hierarchical_evaluator_detects_contradictions(  # TODO rewrite first example + turn into classical contradiction test
...
def test_that_parallel_evaluator_detects_contradictions(  # Change into regular contradiction test, change first testcase
    context: _TestContext,
    guideline_a_definition: dict[str, str],
    guideline_b_definition: dict[str, str],
) -> None:
...
def test_that_temporal_evaluator_detects_contradictions(  # TODO turn into optional contradiction
    context: _TestContext,
    guideline_a_definition: dict[str, str],
    guideline_b_definition: dict[str, str],
) -> None:
...
def test_that_contextual_evaluator_detects_contradictions(  # TODO turn into a "possible contradiction"
    context: _TestContext,
    guideline_a_definition: dict[str, str],
    guideline_b_definition: dict[str, str],
) -> None:
...
def test_that_contextual_evaluator_does_not_produce_false_positives(  # TODO turn into a "possible contradiction" test
    context: _TestContext,
    guideline_a_definition: dict[str, str],
    guideline_b_definition: dict[str, str],
) -> None:
...
def test_that_coherence_check_does_not_produce_false_positives(  # TODO keep but alter test
    context: _TestContext,
    sync_await: SyncAwaiter,
...
def test_that_coherence_check_produces_multiple_contradictions(  # TODO rewrite completley
    context: _TestContext,
    sync_await: SyncAwaiter,
...
def test_that_existing_guidelines_are_not_evaluated_as_proposed_guidelines(  # TODO keep but adjust to new format
    context: _TestContext,
) -> None:
