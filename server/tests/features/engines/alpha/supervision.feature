Feature: Supervision
    ...
    Scenario: Prioritizing freezing transactions over processing refunds
        ...
        And that the "freeze_transactions" guideline is proposed with a priority of 10 because "An error in the last transaction occurred, which is unusual and raises concerns."
        And that the "process_refund" guideline is proposed with a priority of 9 because "The customer explicitly requested a refund."
