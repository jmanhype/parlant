Feature: Supervision
    ...
    Scenario: Prioritizing selling pizza over transferring the upset customer to the manager
        ...
        And propose the "selling_pizza" guideline with a score of 9 because "The conversation was initiated, indicating a new customer has arrived."
        And propose the "customer_upset" guideline with a score of 7 because "The customer is visibly upset about the wait."
    ...
    Scenario: Prioritizing transferring the upset customer to the manager over offering pizza
        ...
        And a guideline "customer_upset", to transfer the upset customer to the manager when the customer is upset
        And a user message, "I came to eat some pizza, but the line was so long! I'm so upset!"
        And propose the "selling_pizza" guideline with a score of 7 because "The conversation was initiated, indicating a new customer has arrived."
        And propose the "customer_upset" guideline with a score of 8 because "The customer is visibly upset about the wait."
        When message processing is triggered
    ...
    Scenario: Adherence to guidelines without fabricating responses
        ...
        And propose the "account_related_questions" guideline with a score of 10 because "User inquired about their account balance."
        When message processing is triggered
